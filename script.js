// Write your JavaScript code here
   ...
   window.addEventListener("load", function() {
      ...
      let fautlyItemsStatus = document.getElementById(faultyItems);
      ...
      function fuelStatusLevel() {
         if (fuelStatusInput.value < 10000) {
            faultyItemsStatus.innerHTML = "Visible";
            pilotStatusInput.innerHTML = `${pilotName.value} is ready for launch`;
            copilotStatusInput.innerHTML =`${copilotName.value} is ready for launch`;
